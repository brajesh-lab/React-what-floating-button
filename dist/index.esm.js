...
var WhatsAppFloating = function (_a) {
    ...
    var _o = useState(""), userMessage = _o[0], setUserMessage = _o[1];
    ...
    return (jsxs("div", { children: [jsx("div", { onClick: function () { return setIsOpen(!isOpen); }, style: __assign$1(__assign$1({ position: "fixed", bottom: "20px" }, positionStyles[position]), { backgroundColor: buttonColor, borderRadius: "50%", width: "".concat(buttonSize, "px"), height: "".concat(buttonSize, "px"), display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", boxShadow: "0px 4px 10px rgba(0,0,0,0.3)", zIndex: zIndex, transition: "transform 0.3s ease" }), onMouseEnter: function (e) {
                    e.currentTarget.style.transform = "scale(1.1)";
                }, onMouseLeave: function (e) {
                    e.currentTarget.style.transform = "scale(1)";
                }, children: jsx(FaWhatsapp, { size: buttonSize * 0.5, color: textColor }) }), isOpen && (jsxs("div", { style: __assign$1(__assign$1({ position: "fixed", bottom: "".concat(buttonSize + 30, "px") }, positionStyles[position]), { width: "300px", background: "#fff", borderRadius: "10px", boxShadow: "0px 4px 20px rgba(0,0,0,0.15)", overflow: "hidden", zIndex: zIndex, animation: "slideUp 0.3s ease" }), children: [jsxs("div", { style: {
                            display: "flex",
                            alignItems: "center",
                            ...
                            color: textColor,
                            padding: "15px",
                        }, children: [jsxs("div", { style: { display: "flex", alignItems: "center", gap: "10px" }, children: [companyLogo && (jsx("img", { src: companyLogo, alt: "".concat(companyName, " logo"), style: {
                                            width: "40px",
                                            height: "40px",
                                            borderRadius: "50%",
                                            objectFit: "cover",
                                            border: "1px solid ".concat(textColor),
                                        } })), jsxs("div", { children: [jsx("div", { style: { fontWeight: "bold", fontSize: "14px" }, children: companyName }), jsx("div", { style: { fontSize: "12px", opacity: 0.8 }, children: replyTime })] })] }), jsx("button", { onClick: function () { return setIsOpen(false); }, style: {
                                    ...
                                    width: "20px",
                                    height: "20px",
                                }, "aria-label": "Close chat", children: "\u00D7" })] }), jsx("div", { style: {
                            padding: "15px",
                            fontSize: "14px",
                            background: "#ece5dd",
                            lineHeight: "1.4",
                        }, children: message }), jsxs("div", { style: { display: "flex", borderTop: "1px solid #e0e0e0" }, children: [jsx("input", { type: "text", value: userMessage, onChange: function (e) { return setUserMessage(e.target.value); }, onKeyDown: handleKeyDown, placeholder: placeholder, style: {
                                    flex: 1,
                                    border: "none",
                                    padding: "15px",
                                    fontSize: "14px",
                                    outline: "none",
                                    backgroundColor: "#fff",
                                } }), jsx("button", { onClick: handleSend, disabled: !userMessage.trim(), style: {
                                    background: "transparent",
                                    border: "none",
                                    padding: "15px",
                                ...
                                }, "aria-label": "Send message", children: "\u27A4" })] })] })), jsx("style", { children: "\n          @keyframes slideUp {\n            from {\n              opacity: 0;\n              transform: translateY(20px);\n            }\n            to {\n              opacity: 1;\n              transform: translateY(0);\n            }\n          }\n        " })] }));
};

export { WhatsAppFloating, WhatsAppFloating as default };
